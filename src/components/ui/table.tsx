            ...
            {paginated.length === 0 ? (
              <tr>
                <td
                  ...
                  className="px-4 py-8 text-center text-sm text-[#9B8B7F]"
                >
                  {emptyMessage}
                </td>
              </tr>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between border-t border-gray-100 px-4 py-2.5">
          ...
          <div className="flex items-center gap-1">
            <button
              className="rounded p-1 text-[#9B8B7F] hover:bg-[#FFF3E6] disabled:opacity-40"
              onClick={() => setPage((p) => Math.max(0, p - 1))}
              disabled={page === 0}
            >
              <ChevronLeft className="h-4 w-4" />
            </button>
            <span className="px-2 text-xs text-[#6B5B4F]">
              {page + 1} / {totalPages}
            </span>
            <button
              className="rounded p-1 text-[#9B8B7F] hover:bg-[#FFF3E6] disabled:opacity-40"
